...
inversion_semestre = st.number_input('Inversión que estimas hacer por semestre', value=4000000, step=100000)
inversion_total = semestres * inversion_semestre
st.write(f"Tu inversión total será de: {inversion_total} COP")
