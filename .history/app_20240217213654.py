...
st.header(f":blue[Descubre la carrera ideal en el campo que te apasiona y te permita recuperar rápidamente tu inversión.]")
st.divider()

st.write(f"temprature: :blue[{df_salario.shape[0]}]")
